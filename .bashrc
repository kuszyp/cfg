...
# ------------------------------------
# I have moved user variables into separate file that is included here.
...
#
# lazygit - changing directory on exit
# ------------------------------------
# if you change the directory and want the shell to change directory into that repo on exitting lazygit
lg() {
...
# pnpm
export PNPM_HOME="/home/kuszyp/.local/share/pnpm"
case ":$PATH:" in
*":$PNPM_HOME:"*) ;;
